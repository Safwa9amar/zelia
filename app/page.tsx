      ...
      <main>
        ...
        <section className="section">
          <div className="container">
            <div className="section-header">
              <div>
                <span className="section-eyebrow">وصلت حديثاً</span>
                <h2 className="section-title">التشكيلة الجديدة</h2>
              </div>
              <Link
                href="/catalog?sort=newest"
                className="btn-outline see-all-btn"
              >
                عرض الكل
                <svg
                  width="14"
        ...
        {saleProducts.length > 0 && (
          <section className="section">
            <div className="container">
              <div className="section-header">
                <div>
                  <span className="section-eyebrow">لا تفوّتيها</span>
